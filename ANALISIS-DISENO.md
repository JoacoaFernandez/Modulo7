...
### Paso 3 — Frontend: sistema visual
...
2. `index.css` — definir los tokens del diseño (`--navy #1A2B48`, `--blue #2D5DA1`, `--green #127453`, `--red #A51C30`, `--bg #F8F9FA`, `--border #E2E6EC`, la escala `#D7E1F0/#6D94C7/#2D5DA1` de las barras, los 7 `GASTO_COLORS`), mapearlos a las variables de shadcn, y setear `font-variant-numeric: tabular-nums`. Reemplaza a `@fontsource-variable/geist`.

### Paso 4 — Frontend: estructura y estado
...
### Paso 6 — Frontend: primitivas de gráficos (reutilizables entre los 3 tableros)
...
### Paso 7 — Frontend: los 3 tableros
